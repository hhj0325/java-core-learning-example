...
/**
 * @author Jeff Lee
 * @since 2015-6-18 22:05:44 HashMap 操作对象的决定因子：hashCode与equals
 */
public class HashMapObjT {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("HashMapA Elements:" + hashMapA + "| size :" + hashMapA.size());

        HashMap<B, Integer> hashMapB = new HashMap<B, Integer>();
        hashMapB.put(new B(), 10);
        hashMapB.put(new B(), 5);
        System.out.println("HashMapB Elements:" + hashMapB + "| size :" + hashMapB.size());

        HashMap<C, Integer> hashMapC = new HashMap<C, Integer>();
        hashMapC.put(new C(), 10);
        hashMapC.put(new C(), 5);
        System.out.println("HashMapC Elements:" + hashMapC + "| size :" + hashMapC.size());
    }
}
